...
public class ProyectoFinalApplication {
	public static void main(String[] args) {
		...
		Inventario inventario = new Inventario(); // Ensure Inventario is instantiated
		Controlador controlador = new Controlador(cliente, administrador, productoFactory, inventario);
